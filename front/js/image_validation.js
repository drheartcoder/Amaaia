function validateImage (files,height,width,element_id) 
  {
    ...
    if (typeof files !== "undefined") 
    {
      for (var i=0, l=files.length; i<l; i++) 
      {
            ...
            { 
                ...
                $('#remove').hide();
                $('#upload-f').attr('src', $('#prev_image_url').val()).width(150).height(150);
             ...
             if(files[i].size > 2200000)
             {
                ...
                if(typeof element_id != 'undefined')
                {
                 ...
                 return false;
                  ...
                  {
                          $('#upload-f').attr('src', e.target.result).width(150).height(150);
                          $('#remove').show();
                          var image = new Image();
                          ...
                          image.onload = function () 
                          {
                              ...
                              if (height < image_height || width < image_width ) 
                              {
                                  ...
                                  $('#upload-f').attr('src', file_url).width(150).height(150);
