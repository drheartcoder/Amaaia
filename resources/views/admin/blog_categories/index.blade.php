							...
							<tr class="border-solid">
								...
								<th width="28%">
									<div class="dataTables_filter">
										Blog Category Name
										<input type="text" name="q_blogcategoryname" placeholder="Search" class="search-block-new-table column_filter" />
									</div>
								</th>
								<th width="28%">
									<div class="dataTables_filter">
			...
			table_module = $('#table_module').DataTable({
				...
				'columnDefs': [{
					...
					ajax: {
						...
						'data': function(d)
						{
							d['column_filter[q_blogcategoryname]']   = $("input[name='q_blogcategoryname']").val()
							d['column_filter[q_blogcategorydate]']   = $("input[name='q_blogcategorydate']").val()
						}
					},
