								...
								<tr class="border-solid">
									...
									<th width="28%">
										<div class="dataTables_filter">
											Ring Shoulder Type
											<input type="text" name="q_ring_shoulder_type" placeholder="Search" class="search-block-new-table column_filter" />
										</div>
									</th>
									<th width="28%">
										<div class="dataTables_filter">
				...
				table_module = $('#table_module').DataTable({
					...
					'columnDefs': [{
						...
						ajax: {
							...
							'data': function(d)
							{
								d['column_filter[q_ring_shoulder_type]']   = $("input[name='q_ring_shoulder_type']").val()
							}
						},
						...
						{data : 'ring_shoulder_type',"orderable":false,"searchable":true,name:'ring_shoulder_type'},
