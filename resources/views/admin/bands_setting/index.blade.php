							...
							<tr class="border-solid">
								...
								<th width="28%">
									<div class="dataTables_filter">
										Band Setting
										<input type="text" name="q_bandsetting" placeholder="Search" class="search-block-new-table column_filter" />
									</div>
								</th>
								<th width="28%">
									<div class="dataTables_filter">
										Added On
										{{-- <input type="text" name="q_branddate" placeholder="Search" class="search-block-new-table column_filter" /> --}}
									</div>
								</th>
								<th>Status</th>
								<th>Actions</th>
				...
				'columnDefs': [{
					...
					ajax: {
						...
						'data': function(d)
						{
							...
							d['column_filter[q_bandsetting]']   = $("input[name='q_bandsetting']").val()
...
{data : 'band_setting',"orderable":false,"searchable":true,name:'band_setting'},
