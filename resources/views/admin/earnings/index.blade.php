			...
			$(document).ready(function(){
				tbl_faq = $('#tbl_faq').DataTable({
					...
					'columnDefs': [{
						...
						{ data : 'supplier_amount', "orderable":false, "searchable":false, name:'supplier_amount' },
						{ data : 'earnings',        "orderable":false, "searchable":false, name:'earnings'        },
