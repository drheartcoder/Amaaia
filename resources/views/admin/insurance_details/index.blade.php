							...
							<tr class="border-solid">
								...
								<th width="25%">
									<div class="dataTables_filter">
										Company Name
										<input type="text" name="q_companyname" placeholder="Search" class="search-block-new-table column_filter" />
									</div>
								</th>
								...
								<th width="25%">
									<div class="dataTables_filter">
										Insurance Amount (%)
										<input type="text" name="q_insuranceamount" placeholder="Search" class="search-block-new-table column_filter" />
									</div>
								</th>
								...
								<th width="25%">
									<div class="dataTables_filter">
										Added On
{{-- 										<input type="text" name="q_companydate" placeholder="Search" class="search-block-new-table column_filter" /> --}}
									</div>
								</th>
								<th>Status</th>
								<th>Actions</th>
			...
			table_module = $('#table_module').DataTable({
				...
				'columnDefs': [{
					...
					ajax: {
						...
						'data': function(d)
						{
							d['column_filter[q_companyname]']     = $("input[name='q_companyname']").val()
							d['column_filter[q_insuranceamount]'] = $("input[name='q_insuranceamount']").val()
							d['column_filter[q_companydate]']     = $("input[name='q_companydate']").val()
					...
					{data : 'company_name',"orderable":false,"searchable":true,name:'company_name'},
