							...
							<form class="form-horizontal" id="frm_add_categogry" name="frm_add_categogry" action="{{$form_url_path}}/store" method="post">
								...
								<fieldset class="content-group">	
									<div class="form-group">
										...
										<div class="col-lg-5">
											<input type="text" name="company_name" id="company_name" class="form-control" placeholder="Company Name" data-rule-required="true"  data-rule-maxlength="60" value="">
									...
									<div class="form-group">
										...
										<div class="col-lg-5">
										<textarea class="form-control" placeholder="Insurance Details" name="description" id="description"></textarea>
 										</div>
									</div>
