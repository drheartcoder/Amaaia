...
@include('admin.layout.breadcrumb')  
	        ...
	        <style type="text/css">
	        	...
	        	<div class="content">
	        		...
	        		<div class="panel panel-flat">
	        			...
	        			<div class="panel-body">
	        				...
	        				<form class="form-horizontal" id="frm_add_categogry" name="frm_add_categogry" action="{{$form_url_path}}/store" method="post" enctype="multipart/form-data">
	        					{{csrf_field()}}
	        					<fieldset class="content-group">

	        						<div class="form-group">
	        							<label class="control-label col-lg-2" for="category_id">Title<i class="red">*</i></label>
	        							<div class="col-lg-5">
	        								<input type="text" name="title" id="title" class="form-control" placeholder="Collection Title" data-rule-required="true"  data-rule-maxlength="60" value="">
	        						...
	        						<div class="form-group">
	        							...
	        							<div class="col-lg-5">
	        								<textarea class="form-control" data-rule-required='true' data-rule-maxlength="500" placeholder="Collection Description" name="description" id="description"></textarea>
	        							</div>
	        						</div>

	        						<div class="form-group">
	        							<label class="control-label col-lg-2" for="description">Colletion Image<i class="red">*</i></label>
	        							<div class="col-lg-5">
	        									...
	        									<div class="" id="add_lab_div">
	        										<div class="add_pht upload-pic loc_add_pht" id="div_blank" onclick="return add_image(this)" style="height: 150px;width: 150px; float: left;"> 
	        											...
	        											<div id="div_hidden_photo_list" class="div_hidden_photo_list">
	        												<input type="file" name="collection_image" id="collection_image" class="collection_image" style="display:none" data-rule-required="true" />
	        											</div>
	        										</div>
	        									</div>
	        								</div>
	        								<div class="col-lg-10 col-lg-offset-2">
	        									<i class="note col-lg-12"><b>NOTE:</b> Only jpg, png, gif, jpeg type images with maximum size 2 MB are allowed</i>
	        								</div>
	        							</div>
				...
				function add_image(ref) { 
					...
					jQuery('#'+image_id).last().find( ".div_hidden_photo_list" ).last().find( "input[name='collection_image']:last" ).click();
					jQuery('#'+image_id).last().find( ".div_hidden_photo_list" ).last().find( "input[name='collection_image']:last" ).change(function() {
						...
						if(image_ext=="jpg" || image_ext=="png" || image_ext=="gif" || image_ext=="jpeg" || image_ext=="JPG" || image_ext=="PNG" || image_ext=="JPEG" || image_ext=="GIF"){
							...
							if(file.size > 2097152)
				             {
								...
								//$("#"+image_id).find(".div_hidden_photo_list").find("#collection_image").last().remove();
							...
							jQuery('#'+image_id).last().find( ".div_hidden_photo_list" ).last().find( "input[name='collection_image']:last" ).unbind('change');
							jQuery('#'+image_id).last().find( ".div_hidden_photo_list" ).last().find( "input[name='collection_image']:last" ).val('');
				...
				function remove_image(elm) {
					...
					$( "input[name='collection_image']" ).val('');
					jQuery(elm).remove();
				}

				function remove_image_code(){
					$( ".div_hidden_photo_list" ).last().find( "input[name='collection_image']:last" ).remove();
				}
