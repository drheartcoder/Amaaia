							...
							<tr class="border-solid">
								...
								<th width="30%">
									<div class="dataTables_filter">
										Collection Name
										<input type="text" name="q_collectionname" placeholder="Search" class="search-block-new-table column_filter" />
									</div>
								</th>
								<th width="20%">
									<div class="dataTables_filter">
			...
			table_module = $('#table_module').DataTable({
				...
				'columnDefs': [{
					...
					ajax: {
						...
						'data': function(d)
						{
							d['column_filter[q_collectionname]']        = $("input[name='q_collectionname']").val()
							d['column_filter[q_collectiondescription]'] = $("input[name='q_collectiondescription']").val()
							d['column_filter[q_collectiondate]']        = $("input[name='q_collectiondate']").val()
						}
					},
