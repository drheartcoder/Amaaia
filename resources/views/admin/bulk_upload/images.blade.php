...
<script type="text/javascript" src="{{url('/')}}/web_admin/assets/css/style.css"></script>
<script type="text/javascript" src="{{url('/')}}/web_admin/assets/css/dropzone.css"></script>
...
<div class="content">
	...
	<script type="text/javascript" src="{{url('/')}}/web_admin/assets/js/dropzone.js"></script>
