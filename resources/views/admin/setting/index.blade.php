							...
							<tr class="border-solid">
								...
								<th width="28%">
									<div class="dataTables_filter">
										Setting
										<input type="text" name="q_setting" placeholder="Search" class="search-block-new-table column_filter" />
									</div>
								</th>
								<th width="28%">
									<div class="dataTables_filter">
			...
			table_module = $('#table_module').DataTable({
				...
				'columnDefs': [{
					...
					ajax: {
						...
						'data': function(d)
						{
							d['column_filter[q_setting]']   = $("input[name='q_setting']").val()
...
{data : 'setting',"orderable":false,"searchable":true,name:'setting'},
