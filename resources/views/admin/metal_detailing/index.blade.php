							...
							<tr class="border-solid">
								...
								<th width="28%">
									<div class="dataTables_filter">
										Metal Detailing
										<input type="text" name="q_metal_detailing_name" placeholder="Search" class="search-block-new-table column_filter" />
									</div>
								</th>
								<th width="28%">
									<div class="dataTables_filter">
			...
			table_module = $('#table_module').DataTable({
				...
				'columnDefs': [{
					...
					ajax: {
						...
						'data': function(d)
						{
							d['column_filter[q_metal_detailing_name]']   = $("input[name='q_metal_detailing_name']").val()
							d['column_filter[q_metal_detailing_date]']   = $("input[name='q_metal_detailing_date']").val()
						}
					},
...
{data : 'metal_detailing_name',"orderable":false,"searchable":true,name:'metal_detailing_name'},
