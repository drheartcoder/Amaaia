						...
						<tr class="border-solid">
							...
							<th width="27%">
								<div class="dataTables_filter">
									Card Title
									<input type="text" name="q_card_title" placeholder="Search" class="search-block-new-table column_filter" />
								</div>
							</th>
							<th width="15%">
								<div class="dataTables_filter">
			...
			table_module = $('#table_module').DataTable({
				...
				'columnDefs': [{
					...
					ajax: {
						...
						'data': function(d)
						{
							d['column_filter[q_card_title]']   = $("input[name='q_card_title']").val()
						}
					},
