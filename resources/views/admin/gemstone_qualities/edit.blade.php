							...
							<form class="form-horizontal" id="frm_add_categogry" name="frm_add_categogry" action="{{$form_url_path}}/update/{{$id}}" method="post">
								...
								<fieldset class="content-group">	
									<div class="form-group">
										...
										<div class="col-lg-5">
											<input type="text" name="gemstone_quality" value="{{$arr_quality['gemstone_quality'] or ''}}" id="category_name" class="form-control" placeholder="Quality Name" data-rule-required="true"  data-rule-maxlength="60" value="">
