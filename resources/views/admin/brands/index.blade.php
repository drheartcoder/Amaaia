							...
							<tr class="border-solid">
								...
								<th width="28%">
									<div class="dataTables_filter">
										Brand Name
										<input type="text" name="q_brandname" placeholder="Search" class="search-block-new-table column_filter" />
									</div>
								</th>
								<th width="28%">
									<div class="dataTables_filter">
			...
			table_module = $('#table_module').DataTable({
				...
				'columnDefs': [{
					...
					ajax: {
						...
						'data': function(d)
						{
							d['column_filter[q_brandname]']   = $("input[name='q_brandname']").val()
...
{data : 'brand_name',"orderable":true,"searchable":true,name:'brand_name'},
