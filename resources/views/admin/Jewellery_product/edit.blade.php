						...
						<div class="col-md-6">
							<fieldset class="content-group">
								...
								<div class="form-group" id="">
									...
									<div class="col-lg-2">
										<select class="form-control" id="metal_quality" name="metal_quality" data-rule-required="true" data-msg-required="Please select the metal quality.">
								...
								<div class="form-group" id="">
									...
									<div class="col-lg-2">
										<select class="form-control" id="metal_quality_2" name="metal_quality_2" data-msg-required="Please select the metal quality.">
											<option value="">Quality</option>
											@if(isset($arr_metal_quality) && !empty($arr_metal_quality) && is_array($arr_metal_quality))
											@foreach($arr_metal_quality as $metal_quality)
