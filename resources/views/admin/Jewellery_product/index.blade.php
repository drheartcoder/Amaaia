								...
								<tr class="border-solid">
									...
									<th width="28%">
										<div class="dataTables_filter">
											Occasion Name
											<input type="text" name="q_occasion_name" placeholder="Search" class="search-block-new-table column_filter" />
										</div>
									</th>
									<th width="28%">
										<div class="dataTables_filter">
			...
			$(document).ready(function(){
				table_module = $('#table_module').DataTable({
					...
					'columnDefs': [{
						...
						{data : 'occasion_name',"orderable":false,"searchable":true,name:'occasion_name'},
