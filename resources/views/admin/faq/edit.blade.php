			...
			<form class="form-horizontal" id="frm_add_categogry" name="frm_add_categogry" action="{{$module_url_path}}/update/{{$id}}" method="post">
				...
				<fieldset class="content-group">	
					<div class="form-group">
						...
						<div class="col-lg-5">
							<input type="text" name="question" id="question" class="form-control" placeholder="Question" data-rule-required="true"  data-rule-maxlength="255" value="{{$arr_faq['answer'] or ''}}">
					...
					<div class="form-group">
						...
						<div class="col-lg-5">
							<textarea class="form-control" rows="5"  name="answer" id="answer" data-rule-required="true"  data-rule-maxlength="550" placeholder="Answer">{{$arr_faq['question'] or ''}}</textarea>
