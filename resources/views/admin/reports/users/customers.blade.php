	...
	<div class="panel panel-flat">
		<div class="panel-heading">
			...
			<div class="heading-elements">
				<ul class="icons-list">
					<li>
						<a href="{{$module_url_path}}/customers" class="btn btn-default btn-rounded show-tooltip" title="Refresh"><i class="fa fa-refresh"></i></a>
					</li>
				</ul>
			</div>
		</div>
		...
		<br/>
            ...
            <form id="export_form" action="{{$module_url_path}}/customers/export" method="post" >
            {{csrf_field()}}
            <div class="btn-group">
              <div class="col-sm-4">
		...
		$(document).ready(function(){
			table_module = $('#table_module').DataTable({
				...
				'columnDefs': [{
					...
					ajax: {
						'url':'{{ $module_url_path}}/customers/load',
						'data': function(d)
						{
