								...
								<tr class="border-solid">
									<th>
										<div class="dataTables_filter">
											Product ID
											<input type="text" name="q_product_id" placeholder="Search" class="search-block-new-table column_filter" />
										</div>
									</th>
									<th>
										<div class="dataTables_filter">
				...
				table_module = $('#table_module').DataTable({
					...
					'columnDefs': [{
						...
						ajax: {
							...
							'data': function(d)
							{
								d['column_filter[q_product_id]']   = $("input[name='q_product_id']").val();
						...
						{ data : 'no_of_reviews', "orderable":false, "searchable":false, name:'no_of_reviews' },
						{ data : 'avg_rating',    "orderable":false, "searchable":false, name:'avg_rating'    },
						],
					});
			});
