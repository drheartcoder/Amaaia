						...
						<tr class="border-solid">
							...
							<th width="28%">
								<div class="dataTables_filter">
									Shank Type
									<input type="text" name="q_shanktype" placeholder="Search" class="search-block-new-table column_filter" />
								</div>
							</th>
							<th width="28%">
								<div class="dataTables_filter">
			...
			table_module = $('#table_module').DataTable({
				...
				'columnDefs': [{
					...
					ajax: {
						...
						'data': function(d)
						{
							d['column_filter[q_shanktype]']   = $("input[name='q_shanktype']").val()
					...
					{data : 'shank_type',"orderable":false,"searchable":true,name:'shank_type'},
