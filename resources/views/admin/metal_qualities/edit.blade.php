							...
							<form class="form-horizontal" id="frm_add_categogry" name="frm_add_categogry" action="{{$form_url_path}}/update/{{$id}}" method="post">
								...
								<fieldset class="content-group">	
									<div class="form-group">
										...
										<div class="col-lg-5">
											<input type="text" name="quality_name" value="{{$arr_quality['quality_name'] or ''}}" id="category_name" class="form-control" placeholder="Quality Name" data-rule-required="true"  data-rule-maxlength="60" value="">
											<span class="error">{{ $errors->first('quality_name') }} </span>
										</div>
									</div>
