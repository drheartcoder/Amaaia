								...
								<tr class="border-solid">
									...
									<th width="28%">
										<div class="dataTables_filter">
											Blog Name
											<input type="text" name="q_blogname" placeholder="Search" class="search-block-new-table column_filter" />
										</div>
									</th>
									<th width="28%">
										<div class="dataTables_filter">
									...
									<th width="20%">
										<div class="dataTables_filter">
											Added On
											{{-- <input type="text" name="q_blogdate" placeholder="Search" class="search-block-new-table column_filter" /> --}}
										</div>
									</th>
									<th>Status</th>
									<th>Actions</th>
			...
			table_module = $('#table_module').DataTable({
				...
				'columnDefs': [{
					...
					ajax: {
						...
						'data': function(d)
						{
							d['column_filter[q_blogname]']        = $("input[name='q_blogname']").val()
