			...
			<form class="form-horizontal" id="frm_add_categogry" name="frm_add_categogry" action="{{$form_url_path}}/store" method="post" enctype="multipart/form-data">
				...
				<fieldset class="content-group">
					<div class="form-group" id="category_block">
						...
						<div class="col-lg-5">
							<select class="form-control" id="category_id" name="category_id" data-rule-required="true">
								...
								<option value="{{base64_encode($category['id'])}}">{{$category['category_name']}}</option>
								@endforeach
								@endif
							</select>
					...
					<div class="form-group">
						...
						<div class="col-lg-5">
							<input type="text" name="title" id="title" class="form-control" placeholder="Blog Name" data-rule-required="true"  data-rule-maxlength="60" value="">
					...
					<div class="form-group">
						...
						<div class="col-lg-6">
							<textarea class="form-control" data-rule-required='true' placeholder="Insurance Description" name="description" id="description" rows="15"></textarea>
						</div>
					</div>
					...
					<div class="form-group">
								...
								<div class="" id="add_lab_div">
									<div class="add_pht upload-pic loc_add_pht" id="div_blank" onclick="return add_image(this)" style="height: 150px;width: 150px; float: left;"> 
										...
										<div id="div_hidden_photo_list" class="div_hidden_photo_list">
											<input type="file" name="blog_image" id="blog_image" class="blog_image" style="display:none" data-rule-required="true" />
										</div>
									</div>
								</div>
							</div>
						...
						<div class="form-group text-center">
							<div class="col-lg-7">
								<button type="submit" class="btn btn-primary" id="btn_add_blog">Add</button>
							</div>
						</div>
						<div>
