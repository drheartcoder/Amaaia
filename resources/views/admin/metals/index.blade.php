						...
						<tr class="border-solid">
							...
							<th width="20%">
								<div class="dataTables_filter">
									Metal Name
									<input type="text" name="q_metalname" placeholder="Search" class="search-block-new-table column_filter" />
								</div>
							</th>
			...
			table_module = $('#table_module').DataTable({
				...
				'columnDefs': [{
					...
					ajax: {
						...
						'data': function(d)
						{
							d['column_filter[q_metalname]']    = $("input[name='q_metalname']").val()
						}
					},
					...
					{data : 'metal_name',"orderable":false,"searchable":true,name:'metal_name'},
