			...
			<form class="form-horizontal" id="frm_add_categogry" name="frm_add_categogry" action="{{$form_url_path}}/update/{{$id}}" method="post">
				...
				<fieldset class="content-group">	
					...
					<div class="form-group">
						<label class="control-label col-lg-2" for="category_name">Metal Name<i class="red">*</i></label>
						<div class="col-lg-5">
							<input type="text" name="metal_name" value="{{$arr_metal['metal_name'] or ''}}" id="category_name" class="form-control" placeholder="Metal Name" data-rule-required="true"  data-rule-maxlength="60" value="">
