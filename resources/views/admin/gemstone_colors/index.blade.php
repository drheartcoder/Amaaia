						...
						<tr class="border-solid">
							...
							<th width="28%">
								<div class="dataTables_filter">
									Color Name
									<input type="text" name="q_colorname" placeholder="Search" class="search-block-new-table column_filter" />
								</div>
							</th>
							<th width="28%">
								<div class="dataTables_filter">
									Added On
									{{-- <input type="text" name="q_colordate" placeholder="Search" class="search-block-new-table column_filter" /> --}}
								</div>
							</th>
							<th>Status</th>
							<th>Actions</th>
			...
			table_module = $('#table_module').DataTable({
				...
				'columnDefs': [{
					...
					ajax: {
						...
						'data': function(d)
						{
							d['column_filter[q_colorname]']   = $("input[name='q_colorname']").val()
							d['column_filter[q_colordate]']   = $("input[name='q_colordate']").val()
						}
					},
					...
					{data : 'gemstone_color',"orderable":false,"searchable":true,name:'gemstone_color'},
