...
<head>
    ...
    <link href="{{url('/')}}/web_supplier/assets/css/custom.css" rel="stylesheet" type="text/css">
    <link href="{{url('/')}}/web_supplier/assets/css/sweetalert.css" rel="stylesheet" type="text/css">
    <link href="{{url('/')}}/web_supplier/assets/css/icons/fontawesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
    <!-- /global stylesheets -->

    <script src="{{url('/')}}/web_supplier/assets/js/core/libraries/jquery.min.js"></script>
    <script type="text/javascript" src="{{url('/')}}/web_supplier/assets/js/pages/image_validation.js"></script>
...
<body class="{{ theme_body_color() }}">
    <!-- Main navbar -->
    @php
    $supplier_path = config('app.project.supplier_panel_slug');
    @endphp
    <div class="navbar navbar-inverse {{supplier_navbar_color()}}">
        <div class="navbar-header">
            <a class="navbar-brand" href="{{url('/')}}/supplier/dashboard"><img src="{{url('/').config('app.project.img_path.website_logo')}}" alt="Profile Image"></a>
        ...
        <div class="navbar-collapse collapse" id="navbar-mobile">
            ...
            <ul class="nav navbar-nav navbar-right">
               ...
               $arr_unread_notifications = get_supplier_unread_notifications();
               @endphp
               <li class="dropdown manage_notification">
                ...
                <div class="dropdown-menu dropdown-content width-350">
                    ...
                    <ul class="media-list dropdown-content-body">
                        ...
                        <li class="media">
                            <div class="media-left">
                                <img src="{{url('/web_supplier/assets/images/placeholder.jpg')}}" class="img-circle img-sm" alt="Profile Image">
                            ...
                            <div class="media-body">
                                ...
                                <span class="text-muted">
                                    ...
                                    @endphp
                                    <a href="javascript:void(0)" class="view_notification" data-notification-id="{{isset($val['id']) ? base64_encode($val['id']) : 0}}" data-notification-url="{{url('/').'/supplier/'.$notification_url }}"><?php echo isset($val['notification_message']) ? htmlspecialchars_decode($val['notification_message']) : '' ?> </a>
                                </span>
                            </div>
                        </li>
                        @endforeach
                    ...
                    <div class="dropdown-content-footer">
                        <a href="{{url('/')}}/supplier/notifications" data-popup="tooltip" title="All Notifications"><i class="icon-menu display-block"></i></a>
                    </div>
                </div>
            </li>
            <li class="dropdown dropdown-user">
                <a class="dropdown-toggle" data-toggle="dropdown">
                    ...
                    <span>{{$shared_supplier_details['first_name'] or ''}}</span>
                    <i class="caret"></i>
                </a>

                <ul class="dropdown-menu dropdown-menu-right">
                    <li><a href="{{url('')}}/supplier/account_setting/personal"><i class="icon-user-plus"></i> Personal Details</a></li>
                    <li><a href="{{url('')}}/supplier/password/change"><i class="icon-key"></i> Change Password</a></li>
                    <li class="divider"></li>
                    <li><a href="{{ url('/').'/'.$supplier_path }}/logout "><i class="icon-switch2"></i> Logout</a></li>
                </ul>
            </li>
        </ul>
    </div>
    ...
    <script>
        $(document).ready(function(){
            $(document).on('click','.view_notification',function(){
                ...
                $.ajax({
                    url:'{{url('/')}}/supplier/notifications/read/'+notification_id,
                    type:'get',
