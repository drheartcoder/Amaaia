...
<!-- BEGIN Main Content -->
				...
				<div class="content">
						...
						<div class="panel-body">
							<form class="form-horizontal" id="frm_change_password" name="frm_change_password" action="{{url($supplier_panel_slug.'/password/update/'.base64_encode($shared_supplier_details['id']))}}" method="post">
								{{csrf_field()}}
