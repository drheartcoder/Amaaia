        ...
        <div class="panel-body">
                 ...
                 <?php $total = 0; ?>
                    ...
                    @foreach($arr_orders['order_products'] as $key=>$product)
                        ...
                        <tr>
                            ...
                            <td>
                                {{isset($product['product_price'])&&isset($product['product_quantity'])  ? $product['product_price']*$product['product_quantity'] : 0}}
                            </td>
                            <td><a class="btn btn-default btn-rounded show-tooltip" href="{{$module_url_path}}/order_product/{{$order_status}}/{{base64_encode($product['id'])}}/{{base64_encode($id)}}" title="View" data-original-title="View"><i class="fa fa-eye"></i></a></td>
                        </tr>
            ...
            <div class="row">
                <div class="col-md-12" style="text-align: right;">
                    ...
                    <p><strong>Total:</strong> <span class="green font-size-17"><strong><i class="fa fa-inr"></i> {{isset($arr_orders['order_id']) ? get_supplier_my_earning($arr_orders['order_id']) : ''}}</strong></span></p>	
                    <p>
                        <br>
