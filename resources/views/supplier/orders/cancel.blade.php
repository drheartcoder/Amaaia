			...
			<div class="panel panel-flat">
				<div class="panel-heading">
					...
					<div class="heading-elements">
						<ul class="icons-list">
							<li>
								<a href="{{$module_url_path}}/cancelled" class="btn btn-default btn-rounded show-tooltip" title="Refresh"><i class="fa fa-refresh"></i></a>
							</li>
						</ul>
					</div>
				</div>
			...
			$(document).ready(function(){
				tbl_faq = $('#tbl_faq').DataTable({
					...
					'columnDefs': [{
						...
						ajax: {
							'url':'{{ $module_url_path}}/cancel/load',
							'data': function(d)
							{
