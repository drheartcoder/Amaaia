...
@php
    ...
    $collection_name             = isset($arr_collection_data['name']) ? $arr_collection_data['name'] : '';
...
<div class="bradcrum-inner">
    ...
    <div class="pul-right-sublink">
        <a href="{{ url('/') }}">Home</a> / <span>{{ $page_title }}</span>
    </div>
...
<div class="container-fluid">
 ...
 <div class="col-md-12">
    ...
    <div class="col-md-12">
        <div class="collect-six">
        <div class="title-callecltion">{{ $collection_name }}</div>
    </div>

    <div class="collect-six pul-rights">
   
    <div class="list-margin-bottm collection-boxsmain">
