...
<div class="inner-page-main min-hieght-class usergiftmain">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                    <div class="cart-login">
                        ...
                        <form id="frm_product_return_request" name="frm_product_return_request" method="post" action="{{$module_url_path}}/return/proceed">
                          {{csrf_field()}}
                          ...
                          <input type="hidden" name="product_supplier_id" value="{{$arr_order['product_supplier_id'] or ''}}">
                          <div class="row">
                              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                  <div class="title-logins-accounts">Return</div>
                              </div>
                               <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                  <div class="box-form">
                              ...
                              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                  <div class="box-form">
                                       <label>Method Of Refund Payment</label>
                                       <div class="select-style select2 udated-select">
                                          <select class="frm-select" id="refund_payment_method" name="refund_payment_method" data-rule-required='true' data-msg-required='Please select method of delivery.'>
                                              <option value="">Select method of refund payment</option>
                                              <option value="1">Add In Amaaia Wallet</option>
                                              <option value="2">Add in Bank Account</option>
                                          </select>
                                              <span class="error-smg">{{$errors->first('refund_payment_method')}}</span>
                                      </div>
                                    </div>
                              </div>
                               <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
    ...
    <script>
        $(document).ready(function(){
              $('#frm_product_return_request').validate({
                  ignore: [],
