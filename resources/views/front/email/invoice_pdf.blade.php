                ...
                <td style="font-size:12px;text-align: left;border-right:1px solid #c1c1c1;">                        @if(isset($product['product_final_price']))
                    ...
                    <td style="font-size:12px;text-align: left;border-right:1px solid #c1c1c1;">@if(isset($product['insurance_on_product']))
                        ...
                        <td style="font-size:12px;text-align: left;border-right:1px solid #c1c1c1;">
                            ...
                            <span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>{{number_format(($product['product_quantity']*$product['insurance_on_product']) + ($product['product_quantity']*$product['product_final_price']), 2)}}
                    ...
                    <tr>
                        ...
                        <td width="20%" style="font-size:12px;text-align: left;background-color: #fff;font-size:13px;font-weight: bold;border-top:1px solid #c1c1c1; border-right:1px solid #c1c1c1;border-bottom:1px solid #c1c1c1;"><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>{{number_format($subtotal, 2)}}</td>
                    </tr>
                    <tr>
                        ...
                        <tr>
                            ...
                            <tr>
                                ...
                                <td width="20%" style="font-size:12px;text-align: left;background-color: #f1f1f1;font-size:13px;font-weight: bold;border-right:1px solid #c1c1c1;border-bottom:1px solid #c1c1c1;"><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>{{number_format(($order_cost-$giftcard_amount-$wallet_amount), 2)}}</td>
                            </tr>
                        </table>
                        @endif
                    </td>
