...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareGroups = [
        ...
        'auth_supplier'=>
        [ 
            \App\Http\Middleware\Supplier\AuthMiddleware::class,
        ],
        'front_general'=>
        [ 
        ...
        'user'=>
        [ 
            \App\Http\Middleware\Front\UserMiddleware::class,
        ],
        'user_auth_check'=>
        [ 
            \App\Http\Middleware\Front\CheckUserAuthMiddleware::class,
        ],
        'admin_auth_check'=>
        [ 
    ...
    protected $routeMiddleware = [
        ...
        'user' => \App\Http\Middleware\Front\UserMiddleware::class,
    ];
}
