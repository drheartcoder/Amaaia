...
class JewelleryController extends Controller
{
    ...
    {
        $this->arr_view_data             = [];
        $this->module_title              = "Jewellery";
        $this->module_category           = "jewellery";
        ...
        $this->ReviewAndRatingModel      = $review_and_rating_model;

        $this->front_url_path            = url('/');
        $this->module_url_path           = $this->front_url_path."/jewellery";
    ...
    {
        $arr_subcategory = []; 
        $obj_subcategory = $this->SubCategoryModel->where('category_id','2')->limit('4')->get(['subcategory_name','description', 'image']);
        ...
        $obj_reviews = $this->ReviewAndRatingModel->orderBy('rating','DESC')->inRandomOrder()->with('user_details')->take(3)->get();
        ...
        $this->arr_view_data['page_title']                      = 'Jewellery';
        $this->arr_view_data['arr_subcategory']                 = $arr_subcategory;
        $this->arr_view_data['arr_reviews']                     = $arr_reviews;
        $this->arr_view_data['subcategory_image_base_path']     = $this->subcategory_image_base_path;

        return view($this->module_view_folder.'.jewellery_landing',$this->arr_view_data);
    }
...
// for product line
    ...
    return view($this->module_view_folder.'.jewellery',$this->arr_view_data);
