...
class JewelleryProductController extends Controller
{
	...
	)
	{
		...
		$this->module_url_path           = $this->admin_url_path."/products/jewellery";
		$this->module_title              = "Jewellery Product";
		$this->module_view_folder        = "admin.Jewellery_product";
	...
	public function create()
	{
		...
		$this->arr_view_data['module_title']        = "Manage ".str_plural($this->module_title);
		$this->arr_view_data['module_icon']         = $this->module_icon;
		$this->arr_view_data['module_url']     	    = url('/').'/admin/products';
		$this->arr_view_data['module_url_path']     = $this->module_url_path;
		$this->arr_view_data['admin_panel_slug']    = $this->admin_panel_slug;
	...
	public function store(Request $request)
	{
		...
		$admin_id    = $is_product_exist = $first_name = $last_name = $supplier_name = "";
		...
		$arr_product['added_by_user_id']           = $admin_id;
		$arr_product['added_by_user_type']         = '1';
