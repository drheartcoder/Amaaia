...
class NotificationsController extends Controller
{
	...
	{
		$this->NotificationsModel->where('is_read','0')
		->where('receiver_user_type','1')
		->update(['is_read'=>'1']);
	...
	public function load_data(Request $request)
	{
		...
		$obj_notificatins = $obj_notificatins->select(['id', 'notification_message','notification_url', 'is_read', 'created_at'])->where('receiver_user_type','1');
